(function($){
	var $featured = $('#featured'),
		$play_video = $('#play-video'), $player = $('#player'),
	...
	$(window).load(function(){
		...
		$controllers.find('#left-arrow').click( function(){
			...
			$player.html('<iframe id="player" width="100%" height="100%" src="http://www.youtube.com/embed/ESiaZNcGFZg?autoplay=0" frameborder="0" allowfullscreen></iframe>');
			return false;
		} );
		...
		$controllers.find('a.switch').click( function(){
			...
			if ( $this_control.hasClass('active') ) return false;
		...
		$play_video.click( function(){
			$featured.flexslider( 6 );
			$player.html('<iframe id="player" width="100%" height="100%" src="http://www.youtube.com/embed/ESiaZNcGFZg?autoplay=1" frameborder="0" allowfullscreen></iframe>');
			return false;
		} );
	});
})(jQuery)